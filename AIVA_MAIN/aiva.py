    ...
    try:
        while(True):
            ...
            #opening software applications
                ...
                os.startfile(r'C:\Program Files\WindowsApps\CanonicalGroupLimited.Ubuntu22.04LTS_2204.1.23.0_x64__79rhkp1fndgsc\ubuntu2204.exe')    
            ...
            #weather report
            elif there_exists(['weather report','temperature','weather now'],query):
...
if __name__=="__main__":
        ...
        scrollable_text=scrolledtext.ScrolledText(root,state='disabled',height=15,width=87,relief='sunken',bd=5,wrap=tk.WORD,bg='#ccffff',fg='#800000')
